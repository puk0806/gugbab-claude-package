import { NavigationMenu } from "@gugbab/styled-mui";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "3개의 드롭다운 메뉴와 1개의 단순 링크가 혼합된 기본 헤더 네비게이션. Trigger에 호버하면 서브 패널이 나타난다.",
            },
        },
    },
    render: () => <FullDemo />,
...
export const WithExtraLink: Story = {
    parameters: {
        docs: {
            description: {
                story: "홈·연락처 같은 단순 링크 항목과 드롭다운 항목을 혼합한 구성. `Item`에 `Trigger` 없이 `Link`만 두면 된다.",
            },
        },
    },
    render: () => (
