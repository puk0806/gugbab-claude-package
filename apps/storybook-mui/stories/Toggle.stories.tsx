import { Toggle, type ToggleSize, type ToggleVariant } from "@gugbab/styled-mui";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "기본 default variant, md 크기, pressed 상태. 클릭·스페이스·엔터로 on/off 전환이 가능하다.",
            },
        },
    },
...
export const Variants: Story = {
    parameters: {
        docs: {
            description: {
                story: "`default` — 배경 채움 스타일 / `outline` — 테두리 스타일. 둘 다 pressed 상태로 표시한다.",
            },
        },
    },
    render: () => (
