...
export const Multiple: Story = {
    parameters: {
        docs: {
            description: {
                story: '`type="multiple"` — 여러 항목을 동시에 활성화 가능. Bold + Italic 동시 선택 같은 텍스트 서식에 적합.',
            },
        },
    },
...
export const Disabled: Story = {
    parameters: {
        docs: {
            description: {
                story: "`ToggleGroup.Item`에 `disabled` prop 적용. 비활성 항목은 포커스·클릭이 차단되며 Arrow 키 네비에서도 자동으로 건너뛴다.",
            },
        },
    },
    render: () => (
