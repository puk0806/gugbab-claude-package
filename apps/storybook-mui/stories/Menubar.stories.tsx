import { Menubar } from "@gugbab/styled-mui";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "File / Edit / View 3개 메뉴로 구성된 기본 메뉴 바. `ArrowLeft` / `ArrowRight`로 메뉴 간 이동, `Menubar.Menu`의 `value` prop이 필수다.",
            },
        },
    },
    render: () => <DefaultDemo />,
...
export const WithCheckbox: Story = {
    parameters: {
        docs: {
            description: {
                story: "`CheckboxItem` + `ItemIndicator`로 View 메뉴에서 UI 요소 표시 여부를 토글. `Label`로 항목 그룹을 시각적으로 구분한다.",
            },
        },
    },
...
export const WithRadio: Story = {
    parameters: {
        docs: {
            description: {
                story: "`RadioGroup` + `RadioItem`으로 상호 배타적 선택(언어/줌 레벨) 구현. 두 메뉴 각각에서 독립적인 라디오 상태를 관리한다.",
            },
        },
    },
