import { Avatar, type AvatarSize } from "@gugbab/styled-mui";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "이미지가 정상 로드된 기본 상태. 로드되는 동안 600ms 지연 후 폴백이 노출되어 깜빡임을 방지한다.",
            },
        },
    },
...
export const Sizes: Story = {
    parameters: {
        docs: {
            description: {
                story: "`size` prop으로 3단계 크기 선택. CSS 변수(`--gugbab-space-*`) 기반이라 토큰만 바꾸면 일괄 조정된다.",
            },
        },
    },
    render: () => (
...
export const FallbackOnly: Story = {
    parameters: {
        docs: {
            description: {
                story: "`Image` 없이 `Fallback`만 노출. 사용자가 프로필 이미지를 등록하지 않은 일반 케이스.",
            },
        },
    },
