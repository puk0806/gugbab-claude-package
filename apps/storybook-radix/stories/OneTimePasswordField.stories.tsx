import { OneTimePasswordField } from "@gugbab/styled-radix";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "6자리 숫자 OTP 기본 상태. 첫 번째 칸에 포커스 후 입력하면 자동으로 다음 칸으로 이동한다.",
            },
        },
    },
    render: () => <Demo />,
...
export const Alphanumeric: Story = {
    parameters: {
        docs: {
            description: {
                story: '`type="alphanumeric"`으로 숫자 + 영문자 입력을 허용하는 모드. 이메일 인증 코드 등에 활용한다.',
            },
        },
    },
...
export const Disabled: Story = {
    parameters: {
        docs: {
            description: {
                story: "`disabled` prop으로 모든 슬롯 입력을 차단한 상태. 인증 요청 처리 중 UI 잠금 등에 사용한다.",
            },
        },
    },
