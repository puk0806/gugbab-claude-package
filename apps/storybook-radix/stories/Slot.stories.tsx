import { Slot } from "@gugbab/styled-radix";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "Slot이 자식 button을 그대로 렌더링하면서 Slot의 className을 함께 전달하는 기본 동작.",
            },
        },
    },
    render: () => (
...
export const ClassMerge: Story = {
    parameters: {
        docs: {
            description: {
                story: "Slot의 `from-slot` className과 자식의 `from-child` className이 하나의 엘리먼트에 병합된다.",
            },
        },
    },
    render: () => (
...
export const EventChaining: Story = {
    parameters: {
        docs: {
            description: {
                story: "이벤트 핸들러 체이닝. 콘솔을 열면 자식 핸들러 → Slot 핸들러 순으로 실행되는 것을 확인할 수 있다.",
            },
        },
    },
    render: () => (
