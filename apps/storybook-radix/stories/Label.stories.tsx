import { Label } from "@gugbab/styled-radix";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "텍스트만 있는 기본 라벨. 단독으로도 스타일이 적용되며 연결된 input 없이도 표시된다.",
            },
        },
    },
...
export const WithInput: Story = {
    parameters: {
        docs: {
            description: {
                story: "`htmlFor`로 input과 연결. 라벨 클릭 시 input이 포커스를 받고 스크린 리더도 연결 관계를 인식한다.",
            },
        },
    },
    render: () => (
...
export const Disabled: Story = {
    parameters: {
        docs: {
            description: {
                story: "disabled input과 쌍을 이루는 라벨. opacity와 cursor를 통해 상태를 시각적으로 전달한다.",
            },
        },
    },
    render: () => (
