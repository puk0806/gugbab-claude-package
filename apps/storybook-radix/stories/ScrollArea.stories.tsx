import { ScrollArea } from "@gugbab/styled-radix";
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "200×200 고정 영역 안에 50개 항목을 수직 스크롤로 표시. 커스텀 스크롤바가 우측에 노출된다.",
            },
        },
    },
    render: () => (
...
export const Horizontal: Story = {
    parameters: {
        docs: {
            description: {
                story: '`orientation="horizontal"` 스크롤바. `whiteSpace: nowrap` 콘텐츠를 가로로 스크롤할 때 사용한다.',
            },
        },
    },
    render: () => (
...
export const Both: Story = {
    parameters: {
        docs: {
            description: {
                story: "수직·수평 스크롤바를 동시에 사용하는 케이스. 우측 하단 모서리에 `Corner`를 추가해 겹침을 처리한다.",
            },
        },
    },
    render: () => (
