import { Breadcrumbs, type BreadcrumbsSeparatorVariant } from "@gugbab/styled-radix";
...
const SHORT_CRUMBS = [{ label: "Home", href: "/" }, { label: "Products", href: "/products" }, { label: "Detail" }];
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "기본 chevron 구분자를 사용한 3단계 경로. 마지막 항목은 링크 없는 현재 페이지로 표시된다.",
            },
        },
    },
