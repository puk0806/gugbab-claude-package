    ...
    render: () => (
        ...
        >
            ...
            >
                ...
                <Swatch name="bg.surface" cssVar="--gugbab-color-bg-surface" value={T.color.bg.surface} bordered />
                <Swatch name="bg.elevated" cssVar="--gugbab-color-bg-elevated" value={T.color.bg.elevated} bordered />
                <Swatch name="bg.inset" cssVar="--gugbab-color-bg-inset" value={T.color.bg.inset} bordered />
            </Section>
            ...
            >
                <Swatch name="accent.base" cssVar="--gugbab-color-accent-base" value={T.color.accent.base} />
                <Swatch name="accent.hover" cssVar="--gugbab-color-accent-hover" value={T.color.accent.hover} />
                <Swatch name="accent.active" cssVar="--gugbab-color-accent-active" value={T.color.accent.active} />
                <Swatch
                    name="accent.subtle"
            ...
            {T.color.accent2 ? (
                ...
                >
                    <Swatch name="accent2.base" cssVar="--gugbab-color-accent2-base" value={T.color.accent2.base} />
                    <Swatch name="accent2.hover" cssVar="--gugbab-color-accent2-hover" value={T.color.accent2.hover} />
                    <Swatch
                        name="accent2.active"
            ...
            >
                <Swatch name="success.base" cssVar="--gugbab-color-success-base" value={T.color.success.base} />
                <Swatch
                    name="success.subtle"
                    ...
                    bordered
                />
                <Swatch name="warning.base" cssVar="--gugbab-color-warning-base" value={T.color.warning.base} />
                <Swatch
                    name="warning.subtle"
                    ...
                    bordered
                />
                <Swatch name="danger.base" cssVar="--gugbab-color-danger-base" value={T.color.danger.base} />
                <Swatch
                    name="danger.subtle"
                ...
                <Swatch name="info.subtle" cssVar="--gugbab-color-info-subtle" value={T.color.info.subtle} bordered />
            </Section>
