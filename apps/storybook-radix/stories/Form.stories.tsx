...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "기본 폼. 이름과 이메일 두 필드가 default 상태로 표시되며 제출 버튼이 활성화된 초기 상태.",
            },
        },
    },
    render: () => <Demo />,
...
export const WithErrors: Story = {
    parameters: {
        docs: {
            description: {
                story: '`status="error"`를 적용한 상태. 각 Field의 테두리가 에러 색상으로 변경되고 검증 메시지가 노출된다.',
            },
        },
    },
...
export const WithDescription: Story = {
    parameters: {
        docs: {
            description: {
                story: "`Form.Message`로 입력 도움말을 각 필드 아래에 표시하는 패턴. `forceMatch`로 항상 노출한다.",
            },
        },
    },
