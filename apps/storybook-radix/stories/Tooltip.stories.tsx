import { Tooltip } from "@gugbab/styled-radix";
...
function Demo({ delayDuration, label = "도움말 툴팁 텍스트", triggerLabel = "마우스를 올려보세요" }: DemoProps) {
    return (
        <Tooltip.Provider>
...
export const DelayedOpen: Story = {
    ...
    render: () => <Demo delayDuration={800} triggerLabel="800ms 지연 툴팁" label="800ms 후에 열립니다" />,
};
...
export const MultipleTooltips: Story = {
    parameters: {
        docs: {
            description: {
                story: "하나의 `Tooltip.Provider` 아래 여러 Tooltip. Provider의 `skipDelayDuration`으로 연속 hover 시 지연 생략.",
            },
        },
    },
    render: () => (
