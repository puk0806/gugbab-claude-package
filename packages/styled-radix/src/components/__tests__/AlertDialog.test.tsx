...
describe("AlertDialog (styled-radix)", () => {
    ...
    it("Trigger applies grx-alert-dialog__trigger", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("grx-alert-dialog__trigger");
    });

    it("Overlay/Content/Title/Description have BEM classes", () => {
        open(null);
        expect(document.body.querySelector('[data-testid="overlay"]')).toHaveClass("grx-alert-dialog__overlay");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("grx-alert-dialog__content");
        expect(document.body.querySelector('[data-testid="title"]')).toHaveClass("grx-alert-dialog__title");
        expect(document.body.querySelector('[data-testid="desc"]')).toHaveClass("grx-alert-dialog__description");
    });
    ...
    it("Cancel applies grx-alert-dialog__cancel", () => {
        ...
        expect(document.body.querySelector('[data-testid="cancel"]')).toHaveClass("grx-alert-dialog__cancel");
    });
});
