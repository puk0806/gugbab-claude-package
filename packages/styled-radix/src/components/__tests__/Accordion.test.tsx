...
describe("Accordion (styled-radix)", () => {
    ...
    it("Item / Header / Trigger / Content carry their BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("grx-accordion__trigger");
        expect(container.querySelector('[data-testid="content"]')).toHaveClass("grx-accordion__content");
    });
