...
describe("Popover (styled-radix)", () => {
    ...
    it("Anchor / Content / Close have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="anchor"]')).toHaveClass("grx-popover__anchor");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("grx-popover__content");
