...
describe("HoverCard (styled-radix)", () => {
    it("Trigger applies grx-hover-card__trigger", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("grx-hover-card__trigger");
    });
    ...
    it("Content applies grx-hover-card__content when forced open", () => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("grx-hover-card__content");
    });
});
