...
describe("Breadcrumbs (styled-radix)", () => {
    ...
    it.each(["chevron", "slash"] as const)("separator variant %s", (separator) => {
        ...
        expect(container.querySelector('[data-testid="root"]')).toHaveClass(`grx-breadcrumbs--${separator}`);
    });
    ...
    it("List/Item/Link/Separator/Page parts have BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="sep"]')).toHaveClass("grx-breadcrumbs__separator");
