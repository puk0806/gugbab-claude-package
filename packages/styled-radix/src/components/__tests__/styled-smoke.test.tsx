...
describe('styled-radix — export integrity (35 components)', () => {
...
describe('styled-radix — compound part structure', () => {
...
describe('styled-radix — render & className smoke (single-element components)', () => {
  ...
  it('Separator applies grx-separator and orientation modifier', () => {
    const { container, rerender } = render(<Separator data-testid="sep" />);
    const sep1 = container.querySelector('[data-testid="sep"]');
    expect(sep1).toHaveClass('grx-separator');
    expect(sep1).toHaveClass('grx-separator--horizontal');

    rerender(<Separator data-testid="sep" orientation="vertical" />);
    const sep2 = container.querySelector('[data-testid="sep"]');
    expect(sep2).toHaveClass('grx-separator--vertical');
  });

  it('Toggle applies grx-toggle and merges className', () => {
