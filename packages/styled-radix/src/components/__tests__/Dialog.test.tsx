...
describe("Dialog (styled-radix)", () => {
    ...
    it("Overlay/Content/Title/Description/Close have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="overlay"]')).toHaveClass("grx-dialog__overlay");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("grx-dialog__content");
        expect(document.body.querySelector('[data-testid="title"]')).toHaveClass("grx-dialog__title");
        expect(document.body.querySelector('[data-testid="desc"]')).toHaveClass("grx-dialog__description");
    ...
    it.each(["sm", "md", "lg", "xl"] as const)("Content size %s applies modifier", (size) => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass(`grx-dialog__content--${size}`);
    });
});
