...
describe("Collapsible (styled-radix)", () => {
    ...
    it("Trigger and Content carry BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("grx-collapsible__trigger");
        expect(container.querySelector('[data-testid="content"]')).toHaveClass("grx-collapsible__content");
    });
