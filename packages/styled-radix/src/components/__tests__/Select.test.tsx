...
describe("Select (styled-radix)", () => {
    it("Trigger / Value / Content / Viewport / Item have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("grx-select__content");
        expect(document.body.querySelector('[data-testid="viewport"]')).toHaveClass("grx-select__viewport");
    ...
    it.each(["sm", "md"] as const)("Trigger size %s applies modifier", (size) => {
        ...
        expect(document.body.querySelector('[data-testid="trigger"]')).toHaveClass(`grx-select__trigger--${size}`);
    });
    ...
    it("ScrollUpButton / ScrollDownButton apply BEM modifiers", () => {
        ...
        expect(document.body.querySelector('[data-testid="up"]')).toHaveClass("grx-select__scroll-button--up");
        expect(document.body.querySelector('[data-testid="down"]')).toHaveClass("grx-select__scroll-button--down");
    });
});
