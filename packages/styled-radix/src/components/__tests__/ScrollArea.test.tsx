...
describe("ScrollArea (styled-radix)", () => {
    it("Root applies grx-scroll-area", () => {
        const { container } = render(<ScrollArea.Root data-testid="root" />);
        expect(container.querySelector('[data-testid="root"]')).toHaveClass("grx-scroll-area");
    });
    ...
    it("Viewport / Scrollbar / Thumb have BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="viewport"]')).toHaveClass("grx-scroll-area__viewport");
        expect(container.querySelector('[data-testid="scrollbar"]')).toHaveClass("grx-scroll-area__scrollbar");
        expect(container.querySelector('[data-testid="thumb"]')).toHaveClass("grx-scroll-area__thumb");
    });
    ...
    it("Corner exposes BEM class when both axes are mounted", () => {
        ...
        expect(container.querySelector('[data-testid="corner"]')).toHaveClass("grx-scroll-area__corner");
    });
});
