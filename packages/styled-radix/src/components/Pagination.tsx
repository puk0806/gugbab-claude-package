...
const Root = forwardRef<HTMLElement, PaginationStyledRootProps>(function PaginationRoot(
    ...
    return <Headless.Root ref={ref} className={cn("grx-pagination", `grx-pagination--${size}`, className)} {...rest} />;
});
...
const Previous = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
    function PaginationPrevious({ className, ...rest }, ref) {
        return <Headless.Previous ref={ref} className={cn("grx-pagination__prev", className)} {...rest} />;
    },
);
...
const Ellipsis = forwardRef<HTMLSpanElement, HTMLAttributes<HTMLSpanElement>>(function PaginationEllipsis(
    ...
    return <Headless.Ellipsis ref={ref} className={cn("grx-pagination__ellipsis", className)} {...rest} />;
});
