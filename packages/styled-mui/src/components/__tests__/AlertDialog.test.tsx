...
describe("AlertDialog (styled-mui)", () => {
    ...
    it("Trigger applies gmui-alert-dialog__trigger", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("gmui-alert-dialog__trigger");
    });

    it("Overlay/Content/Title/Description have BEM classes", () => {
        open(null);
        expect(document.body.querySelector('[data-testid="overlay"]')).toHaveClass("gmui-alert-dialog__overlay");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-alert-dialog__content");
        expect(document.body.querySelector('[data-testid="title"]')).toHaveClass("gmui-alert-dialog__title");
        expect(document.body.querySelector('[data-testid="desc"]')).toHaveClass("gmui-alert-dialog__description");
    });
    ...
    it("Cancel applies gmui-alert-dialog__cancel", () => {
        ...
        expect(document.body.querySelector('[data-testid="cancel"]')).toHaveClass("gmui-alert-dialog__cancel");
    });
});
