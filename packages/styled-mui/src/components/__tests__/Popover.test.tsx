...
describe("Popover (styled-mui)", () => {
    ...
    it("Anchor / Content / Close have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="anchor"]')).toHaveClass("gmui-popover__anchor");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-popover__content");
