...
describe("Accordion (styled-mui)", () => {
    ...
    it("Item / Header / Trigger / Content carry their BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("gmui-accordion__trigger");
        expect(container.querySelector('[data-testid="content"]')).toHaveClass("gmui-accordion__content");
    });
