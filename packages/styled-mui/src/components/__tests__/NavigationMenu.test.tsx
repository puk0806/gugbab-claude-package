...
describe("NavigationMenu (styled-mui)", () => {
    ...
    it("List/Item/Trigger/Content/Link have BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="list"]')).toHaveClass("gmui-navigation-menu__list");
        expect(container.querySelector('[data-testid="item"]')).toHaveClass("gmui-navigation-menu__item");
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("gmui-navigation-menu__trigger");
        expect(container.querySelector('[data-testid="content"]')).toHaveClass("gmui-navigation-menu__content");
        expect(container.querySelector('[data-testid="link"]')).toHaveClass("gmui-navigation-menu__link");
    });
});
