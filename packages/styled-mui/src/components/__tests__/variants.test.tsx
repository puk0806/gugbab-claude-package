...
describe("Accordion variant", () => {
    it.each(["default", "outline"] as const)("renders gmui-accordion--%s", (variant) => {
        ...
        expect(container.querySelector('[data-testid="root"]')).toHaveClass(`gmui-accordion--${variant}`);
    });
...
describe("Select Trigger size", () => {
    it.each(["sm", "md"] as const)("renders gmui-select__trigger--%s", (size) => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass(`gmui-select__trigger--${size}`);
    });
});
...
describe("ToggleGroup variant + size", () => {
    it.each(["default", "outline"] as const)("renders variant %s", (variant) => {
        ...
        expect(container.querySelector('[data-testid="root"]')).toHaveClass(`gmui-toggle-group--${variant}`);
    });
    ...
    it.each(["sm", "md"] as const)("renders size %s", (size) => {
        ...
        expect(container.querySelector('[data-testid="root"]')).toHaveClass(`gmui-toggle-group--${size}`);
    });
});

describe("Form Field status", () => {
    it.each(["error", "success", "warning"] as const)("Field renders gmui-form__field--%s", (status) => {
        const { container } = render(
            <Form.Root>
