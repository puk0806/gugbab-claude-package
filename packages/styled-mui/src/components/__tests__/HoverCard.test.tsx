...
describe("HoverCard (styled-mui)", () => {
    it("Trigger applies gmui-hover-card__trigger", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("gmui-hover-card__trigger");
    });
    ...
    it("Content applies gmui-hover-card__content when forced open", () => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-hover-card__content");
    });
});
