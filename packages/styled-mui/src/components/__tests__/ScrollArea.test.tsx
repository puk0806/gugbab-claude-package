...
describe("ScrollArea (styled-mui)", () => {
    ...
    it("Viewport / Scrollbar / Thumb have BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="viewport"]')).toHaveClass("gmui-scroll-area__viewport");
        expect(container.querySelector('[data-testid="scrollbar"]')).toHaveClass("gmui-scroll-area__scrollbar");
    ...
    it("Corner exposes BEM class when both axes are mounted", () => {
        ...
        expect(container.querySelector('[data-testid="corner"]')).toHaveClass("gmui-scroll-area__corner");
    });
});
