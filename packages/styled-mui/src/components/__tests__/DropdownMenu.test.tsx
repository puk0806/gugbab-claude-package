...
describe("DropdownMenu (styled-mui)", () => {
    it("Content / Item carry shared gmui-menu__* BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-menu__content");
    ...
    it("CheckboxItem / RadioItem applies item modifier classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="cb"]')).toHaveClass("gmui-menu__item--checkbox");
