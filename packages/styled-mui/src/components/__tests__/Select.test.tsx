...
describe("Select (styled-mui)", () => {
    it("Trigger / Value / Content / Viewport / Item have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-select__content");
        expect(document.body.querySelector('[data-testid="viewport"]')).toHaveClass("gmui-select__viewport");
    ...
    it.each(["sm", "md"] as const)("Trigger size %s applies modifier", (size) => {
        ...
        expect(document.body.querySelector('[data-testid="trigger"]')).toHaveClass(`gmui-select__trigger--${size}`);
    });
    ...
    it("ScrollUpButton / ScrollDownButton apply BEM modifiers", () => {
        ...
        expect(document.body.querySelector('[data-testid="up"]')).toHaveClass("gmui-select__scroll-button--up");
        expect(document.body.querySelector('[data-testid="down"]')).toHaveClass("gmui-select__scroll-button--down");
    });
});
