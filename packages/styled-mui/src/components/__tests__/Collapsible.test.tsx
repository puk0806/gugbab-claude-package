...
describe("Collapsible (styled-mui)", () => {
    ...
    it("Trigger and Content carry BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="trigger"]')).toHaveClass("gmui-collapsible__trigger");
        expect(container.querySelector('[data-testid="content"]')).toHaveClass("gmui-collapsible__content");
    });
