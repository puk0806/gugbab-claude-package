...
describe("Dialog (styled-mui)", () => {
    ...
    it("Overlay/Content/Title/Description/Close have BEM classes", () => {
        ...
        expect(document.body.querySelector('[data-testid="overlay"]')).toHaveClass("gmui-dialog__overlay");
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass("gmui-dialog__content");
        expect(document.body.querySelector('[data-testid="title"]')).toHaveClass("gmui-dialog__title");
        expect(document.body.querySelector('[data-testid="desc"]')).toHaveClass("gmui-dialog__description");
    ...
    it.each(["sm", "md", "lg", "xl"] as const)("Content size %s applies modifier", (size) => {
        ...
        expect(document.body.querySelector('[data-testid="content"]')).toHaveClass(`gmui-dialog__content--${size}`);
    });
});
