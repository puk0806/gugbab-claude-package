...
describe("Breadcrumbs (styled-mui)", () => {
    ...
    it.each(["chevron", "slash"] as const)("separator variant %s", (separator) => {
        ...
        expect(container.querySelector('[data-testid="root"]')).toHaveClass(`gmui-breadcrumbs--${separator}`);
    });
    ...
    it("List/Item/Link/Separator/Page parts have BEM classes", () => {
        ...
        expect(container.querySelector('[data-testid="sep"]')).toHaveClass("gmui-breadcrumbs__separator");
