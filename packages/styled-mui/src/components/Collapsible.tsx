...
const Root = forwardRef<HTMLDivElement, CollapsibleRootProps>(function CollapsibleRoot({ className, ...rest }, ref) {
    return <Headless.Root ref={ref} className={cn("gmui-collapsible", className)} {...rest} />;
});
...
const Trigger = forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement>>(function CollapsibleTrigger(
    ...
    return <Headless.Trigger ref={ref} className={cn("gmui-collapsible__trigger", className)} {...rest} />;
});
...
const Content = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(function CollapsibleContent(
    ...
    return <Headless.Content ref={ref} className={cn("gmui-collapsible__content", className)} {...rest} />;
});
