...
const Viewport = forwardRef<HTMLOListElement, ToastViewportProps>(function ToastViewport({ className, ...rest }, ref) {
...
const Description = forwardRef<HTMLDivElement, ToastDescriptionProps>(function ToastDescription(
    ...
    return <Headless.Description ref={ref} className={cn("gmui-toast__description", className)} {...rest} />;
});
