...
const Root = forwardRef<HTMLDivElement, SliderStyledRootProps>(function SliderRoot(
    ...
    return <Headless.Root ref={ref} className={cn("gmui-slider", `gmui-slider--${size}`, className)} {...rest} />;
});
...
const Thumb = forwardRef<HTMLSpanElement, SliderThumbProps>(function SliderThumb({ className, ...rest }, ref) {
