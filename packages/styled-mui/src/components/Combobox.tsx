...
const Trigger = forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement>>(function ComboboxTrigger(
    ...
    return <Headless.Trigger ref={ref} className={cn("gmui-combobox__trigger", className)} {...rest} />;
});
...
const Content = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(function ComboboxContent(
    ...
    return <Headless.Content ref={ref} className={cn("gmui-combobox__content", className)} {...rest} />;
});
