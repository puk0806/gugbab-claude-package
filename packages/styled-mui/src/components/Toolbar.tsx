...
const Root = forwardRef<HTMLDivElement, ToolbarRootProps>(function ToolbarRoot({ className, ...rest }, ref) {
    return <Headless.Root ref={ref} className={cn("gmui-toolbar", className)} {...rest} />;
});

const Button = forwardRef<HTMLButtonElement, ToolbarButtonProps>(function ToolbarButton({ className, ...rest }, ref) {
    return <Headless.Button ref={ref} className={cn("gmui-toolbar__button", className)} {...rest} />;
});

const Link = forwardRef<HTMLAnchorElement, ToolbarLinkProps>(function ToolbarLink({ className, ...rest }, ref) {
...
const Separator = forwardRef<HTMLDivElement, ToolbarSeparatorProps>(function ToolbarSeparator(
    ...
    return <Headless.Separator ref={ref} className={cn("gmui-toolbar__separator", className)} {...rest} />;
});
...
const ToggleItem = forwardRef<HTMLButtonElement, ToolbarToggleItemProps>(function ToolbarToggleItem(
    ...
    return <Headless.ToggleItem ref={ref} className={cn("gmui-toolbar__toggle-item", className)} {...rest} />;
});
