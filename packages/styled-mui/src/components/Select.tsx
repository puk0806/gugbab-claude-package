...
const Viewport = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(function SelectViewport(
    ...
    return <Headless.Viewport ref={ref} className={cn("gmui-select__viewport", className)} {...rest} />;
});
...
const ItemText = forwardRef<HTMLSpanElement, HTMLAttributes<HTMLSpanElement>>(function SelectItemText(
    ...
    return <Headless.ItemText ref={ref} className={cn("gmui-select__item-text", className)} {...rest} />;
});
