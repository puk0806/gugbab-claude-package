...
│   ├── types-generator/   # @gugbab/types-generator (내부 도구 — OpenAPI → TS 타입 생성, 비배포)
│   └── relay-types/       # @gugbab/relay-types (gugbab-claude-relay API 타입)
├── apps/
...
| `@gugbab/relay-types`         | gugbab-claude-relay API OpenAPI 타입 자동 생성 (13종: ChatRequest, SSEEvent 등). 스펙 변경 시 타임스탬프 버전 자동 publish (changesets 비대상) | 0.1.0-{timestamp} |
